...
st.title("北京公园过敏风险评估系统")

date = st.date_input("日期")

pollen_density = st.slider(
    "背景花粉浓度 (粒/m³)",
    0,
    300,
    46
...
consecutive_sunny_days = st.slider(
    "连续晴天",
    0,
    30,
    11
...
for factor, score in result["主要风险因素"]:
    st.write(f"{factor}：{round(score,2)}")

st.subheader("过敏源贡献")

st.json(result["过敏源小分"])
